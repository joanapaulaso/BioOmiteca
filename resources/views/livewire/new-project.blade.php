                        ...
                        <div class="align-middle inline-block min-w-full px-8 pt-3 rounded-bl-lg rounded-br-lg">
                            ...
                            <div class="md:flex md:w-full">
                                <div class="flex-grow top-0 md:mx-5 my-1 md:p-3 w-full md:w-2/3">
                                    ...
                                    <div class="mx-1">
                                        <input type="number" wire:model="mass.0" maxlength="100" class="w-full border border-blue-400 focus-within:outline-none focus:ring-2 focus:ring-blue-400 rounded-md">
                                    </div>
                                ...
                                <div class="flex-grow top-0 md:mx-5 my-1 md:p-3 w-full md:w-2/3">
                                    ...
                                    <div class="mx-1">
                                        <input type="number" wire:model="adduct.0" maxlength="100" class="w-full border border-blue-400 focus-within:outline-none focus:ring-2 focus:ring-blue-400 rounded-md">
                                    </div>
                            ...
                            <div class="md:flex md:w-full">
                                <div class="flex-grow top-0 md:mx-5 my-1 md:p-3 w-full md:w-2/3">
                                    ...
                                    <div class="mx-1">
                                        <input type="text" wire:model="biblio_ref.0" maxlength="100" class="w-full border border-blue-400 focus-within:outline-none focus:ring-2 focus:ring-blue-400 rounded-md">
                                    </div>
                        ...
                        <div class="align-middle inline-block min-w-full px-8 pt-3 rounded-bl-lg rounded-br-lg">
                            ...
                            <div class="md:flex md:w-full">
                                <div class="flex-grow top-0 md:mx-5 my-1 md:p-3 w-full md:w-2/3">
                                    ...
                                    <div class="mx-1">
                                        <input type="number" wire:model="mass.{{ $value }}" maxlength="100" class="w-full border border-blue-400 focus-within:outline-none focus:ring-2 focus:ring-blue-400 rounded-md">
                                    </div>
                                    @error('mass') <p class="text-red-600 text-sm"><br>{{ $message }}</p> @enderror
                                </div>
                                <div class="flex-grow top-0 md:mx-5 my-1 md:p-3 w-full md:w-2/3">
